...
aov.S1
etasq(aov.S1, anova = TRUE) # Provides Eta^2 value, ANOVA = TRUE provides ANOVA table
```
...
aov.S1_STG
summary(aov.S1_STG) #provides ANOVA table
etasq(aov.S1_STG) #provides effect-size (Eta^2) value
```
...
etasq(aov.S1_SPAD) #provides effect-size (Eta^2) value
```
...
etasq(aov.S1_BY) #provides effect-size (Eta^2) value
```
...
etasq(aov.S1_SHER) #provides effect-size (Eta^2) value
```
